...
function App() {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-purple-950 to-blue-600 text-white">
        <h1 className="my-12 text-2xl text-gray-200 font-bold">Weather App</h1>
        {/* search bar & icon */}
